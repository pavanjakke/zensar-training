package com.zensar.microservice.AdmissionsService.resources;
...
import com.zensar.microservice.AdmissionsService.model.patient.DiseasesList;
import com.zensar.microservice.AdmissionsService.model.patient.EmployeesList;
import com.zensar.microservice.AdmissionsService.model.patient.Patient;
...
public class AdmissionsResource {
	...
	List<Patient> patients = Arrays.asList(				
		new Patient("P1", "bujji", "India"),
		new Patient("P2", "kane", "scotland"),
		new Patient("P3", "smith", "Indian")
		);
